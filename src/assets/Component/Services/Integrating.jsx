...
const Integrating = () => {
  return (
    <div className="bg-white">
      <div className="flex flex-col lg:flex-row items-center justify-between w-full px-5 py-10">
        {/* text */}
        <div className="w-[40%]">
          <h1 className="text-[44px] leading-[57px] text-[#111827] font-medium px-5 pt-10 pb-5 w-full">
          ...
          <p className="text-[20px] leading-[30px] text-[#111827] font-normal px-5 pb-5 w-full">
            ...
            just implementation, focusing on three key areas to ensure your CXM
            program succeeds and delivers real
